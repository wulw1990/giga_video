...
CameraSetFly2::CameraSetFly2() {
  m_setting.exposure = 1.30;
  m_setting.gain = 0.0;
  m_setting.brightness = 4.88;

  m_setting.shutter_dynamic.push_back(0);
  m_setting.shutter_dynamic.push_back(0);
  m_setting.shutter_min.push_back(5.0);
  m_setting.shutter_min.push_back(5.0);
  m_setting.shutter_max.push_back(5.0);
  m_setting.shutter_max.push_back(5.0);
...
CameraSetFly2::Setting::Setting(string setting_file) {
  ...
  if (!fs.isOpened()) {
    cout << "Could not open the configuration file: \"" << setting_file << "\""
         << endl;
    exit(-1);
  }
  // const int W = 20;
...
string CameraSetFly2::Setting::readStringItem(FileStorage &fs,
                                              string node_name) {
  string str;
  fs[node_name] >> str;
...
vector<string> CameraSetFly2::Setting::readStringList(FileStorage &fs,
                                                      string node_name) {
  vector<string> list;
...
vector<int>
CameraSetFly2::Setting::stringList2IntList(std::vector<std::string> str) {
...
vector<double>
CameraSetFly2::Setting::stringList2DoubleList(std::vector<std::string> str) {
